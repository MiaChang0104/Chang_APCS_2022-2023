...
public class IsItLegalForYou {
    ...
    if (number >=65) {
        ...
        System.out.println("rent a car, buy alcohol, buy cigarettes, go to a casino, get a driver's license, get a job");
    }   else if (number >=21) {
        System.out.println("buy alcohol, buy cigarettes, go to a casino, get a driver's license, get a job");
    }   else if (number >= 18) {
        System.out.println("go to a casino, get a driver's license, get a job");
    }   else if (number >= 16){
        System.out.println("get a driver's license, get a job");
    }   else if (number >=14){
